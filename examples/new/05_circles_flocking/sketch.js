...
var wind = new PVector();//createVector(0,0,0);
var basewind = new PVector();
var gust = new PVector();
...
function gotWeather(weather) {
  ...
  basewind = PVector.fromAngle(radians(dir));
  basewind.mult(windmag/100);
  gust = PVector.fromAngle(radians(dir));
